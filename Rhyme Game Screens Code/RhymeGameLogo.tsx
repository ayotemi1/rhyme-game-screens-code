  ...
  export function RhymeGameLogo({ size = "medium" }: LogoProps) {
    ...
    return (
      <div style={{ display: "inline-flex", flexDirection: "column", alignItems: "center", position: "relative" }}>
        {/* Ball — centered above THE, clear gap */}
        <div style={{
          alignSelf: "center",
          marginBottom: 8,
          zIndex: 10,
        ...
        {/* THE */}
        <div style={{ background: "#EDE8D4", borderRadius: s.br, padding: s.thePad, zIndex: 3, marginBottom: s.overlap, boxShadow: "0 4px 16px rgba(0,0,0,0.25)", alignSelf: "center" }}>
          <span style={{ fontFamily: FONT, fontWeight: 400, fontSize: s.THE, color: "#1A0E4E", letterSpacing: 1, lineHeight: 1 }}>THE</span>
        </div>
        {/* RHYME */}
        <div style={{ background: "#1A0E4E", borderRadius: s.br, padding: s.rhymePad, zIndex: 4, boxShadow: "0 8px 28px rgba(0,0,0,0.45)", alignSelf: "center" }}>
          <span style={{ fontFamily: FONT, fontWeight: 400, fontSize: s.RHYME, color: "#EDE8D4", letterSpacing: 1, lineHeight: 1 }}>RHYME</span>
        </div>
        {/* GAME */}
        <div style={{ background: "#EDE8D4", borderRadius: s.br, padding: s.gamePad, zIndex: 3, marginTop: s.overlap, boxShadow: "0 4px 16px rgba(0,0,0,0.25)", alignSelf: "center" }}>
